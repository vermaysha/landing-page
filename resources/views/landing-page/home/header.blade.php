            ...
            <div class="row align-items-end">
                <div class="col-lg-6">
                    <div class="hero-content-wrapper">
                        <h4 class="wow fadeInUp" data-wow-delay=".2s"
                            style="visibility: visible; animation-delay: 0.2s; animation-name: fadeInUp;">Wujudkan Masa Depan
                            Digitalmu !</h4>
                        <h2 class="mb-30 wow fadeInUp" data-wow-delay=".4s"
                            style="visibility: visible; animation-delay: 0.4s; animation-name: fadeInUp;">Solusi Digital Anda untuk
                            Masa Depan yang Lebih Baik</h2>
                        <p class="mb-50 wow fadeInUp" data-wow-delay=".6s"
                            style="visibility: visible; animation-delay: 0.6s; animation-name: fadeInUp;">Perfect Coding adalah
                ...
                <div class="d-none d-lg-block col-lg-6">
                    <div class="hero-image">
                        <img src="{{ Vite::asset('resources/img/home/hero-img.svg') }}" alt="" class="wow fadeInRight"
                            data-wow-delay=".2s" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeInRight;">
                        <img src="{{ Vite::asset('resources/img/home/paattern.svg') }}" alt="" class="shape shape-1">
                    </div>
                </div>
            </div>
        </div>
