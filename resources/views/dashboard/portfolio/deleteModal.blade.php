<div class="modal modal-blur fade" id="modal-delete-portfolio-{{ $row->id }}" tabindex="-1" role="dialog"
    aria-modal="true">
    <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
        <form action="{{ route('dashboard.portfolio.delete', ['id' => $row->id]) }}" method="post">
            @csrf
            @method('DELETE')
            <div class="modal-content">
                ...
                <div class="modal-body text-center py-4">
                    ...
                    <h3>Are you sure?</h3>
                    <div class="text-secondary">Do you really want to delete portfolio from
